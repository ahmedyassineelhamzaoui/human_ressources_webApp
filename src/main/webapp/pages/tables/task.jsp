            ...
            <div class="d-flex flex-column">
                ...
                <div>
                    ...
                    <nav class="navbar navbar-expand  mb-4 shadow">
                        <div>
                            <p class="fs-5 ms-4">Welcome <%= " "+userConected.getFirstName()+" "+userConected.getLastName() %> !</p>
                        </div>
                    </nav>
                    <%--          End of Topbar ---%>
                    <%--          Begin Page Content ----%>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">												
															<button type="button" class="btn btn-danger me-1" onclick="showDeleteTaskConfirmation(<%=t.getId()%>);">
