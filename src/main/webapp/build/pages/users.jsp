          ...
          <div class="flex-none w-full max-w-full px-3">
            <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">
              <div class="p-2 d-flex justify-content-between align-items-center">
                <h6>Users table</h6>
                <button style="color:black" type="button" class="btn btn-primary" data-bs-target="#addUser" data-bs-toggle="modal">+ Add User</button>
              </div>
        ...
        <div class="modal fade" id="addUser" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
		  <div class="modal-dialog modal-dialog-centered">
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
		        ...
		        <div class="row  mb-1">
				  ...
				  <div class="col">
				    ...
				    <input type="password" class="form-control" name="password" placeholder="password" aria-label="passwword">
				  </div>
				</div>
				<div class="row">
				   <div>
				...
				<div class="row  mb-1">
				  ...
				  <div class="col">
				    ...
				    <input type="date"  name="hireDate" class="form-control" placeholder="hire date" aria-label="hire date">
				  </div>
				</div>
				<div class="row  mb-1">
				  <div class="col">
				  ...
				  <div class="col">
				    ...
				    <select name="departement" class="form-select" id="Departments">
				      <option value="1">One</option>
				      <option value="2">Two</option>
				      <option value="3">Three</option>
				    </select>
              ...
              <button style="color:black" type="submit" class="btn btn-primary">Save</button>
		      </div>
		    </div>
		  </div>
		</div>
